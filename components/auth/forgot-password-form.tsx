...
import { resetPasswordForEmail } from "@/lib/supabase/queries";
...
export function ForgotPasswordForm() {
  ...
  function clearFieldError(field: keyof ForgotPasswordFieldErrors) {
    setErrors((previous) => {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const message = "Unable to send reset email.";
      setErrors({ form: message });
      toast.error(message);
    } finally {
    ...
    return (
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          We sent a password reset link to your inbox. Click the link in the email to set a new
          password.
        </p>
